...
//    }
    ...
    struct Card: Identifiable{          //Identifiable 是 swift 提供的 可以建立唯一标识的 formalism， 他是一种 protocol
        ...
        // the last time this card was turned face up(and iss still face up)
        ...
        // whether the card was mathced during the bonus time period
        ...
        // called when the card transitions to face up state    卡转换为面朝上状态时调用
        private mutating func startUsingBonusTime() {
            if isConsumingBonusTime, lastFaceUpDate == nil {    //或者的关系 有一个成立即可
                lastFaceUpDate = Date()
            }
        }
